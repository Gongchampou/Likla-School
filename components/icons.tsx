...
export const TeacherIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><line x1="18" y1="14" x2="22" y2="14" /><line x1="20" y1="12" x2="20" y2="16" /></svg>
);

export const StudentIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" /><path d="M20 22a8 8 0 1 0-16 0" /></svg>
);

export const ClassIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const AttendanceIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const AssignmentIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
...
export const IdCardIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect width="20" height="14" x="2" y="5" rx="2" /><line x1="6" y1="10" x2="10" y2="10" /><line x1="6" y1="14" x2="10" y2="14" /><line x1="14" y1="10" x2="18" y2="10" /><line x1="14" y1="14" x2="18" y2="14" />
  </svg>
);

export const NoticeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M15.75 5.25a3 3 0 0 1 3 3V19l-3.5-2-3.5 2v-1.25" /><path d="M15.75 5.25a3 3 0 0 0-3-3H6.25a2 2 0 0 0-2 2v15.5" /><path d="M9 10h4" /><path d="M9 14h2" />
  </svg>
);

export const FeesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ControlLimitIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 20.94c1.5 0 2.75 1.06 4 1.06 3 0 6-8 6-12.22A4.91 4.91 0 0 0 17 3c-1.5 0-2.75 1.06-4 1.06C9 4.06 6 12.22 6 16.44a4.91 4.91 0 0 0 5 4.5z" />
  </svg>
);
...
export const MoonIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" /></svg>
);
...
export const BinIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const MoreVerticalIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
...
export const WhatsAppIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zM9.6 17.2c-2.3 0-4.1-1.8-4.1-4.1s1.8-4.1 4.1-4.1c1.1 0 2.1.4 2.9 1.2l-1.4 1.4c-.4-.4-.9-.6-1.5-.6-1.4 0-2.5 1.1-2.5 2.5s1.1 2.5 2.5 2.5c1.7 0 2.2-1.1 2.3-1.7h-2.3v-1.9h4.2c.1.2.1.5.1 1 0 2.4-1.6 4.3-4.3 4.3zm5.4-6.2h-1.5V9.5h-2v1.5H10v2h1.5v1.5h2V13h1.5z"></path><path d="M16.6 14.2c-.2-.1-.5-.2-.7-.3-.2-.1-.4-.1-.5.1s-.6.7-.8.9c-.1.1-.3.2-.5.1-.2-.1-1-.4-1.9-1.1s-1.5-1.7-1.7-2c-.1-.2 0-.3.1-.4l.4-.4c.1-.1.1-.2 0-.4-.1-.1-.5-1.1-.7-1.5-.2-.4-.3-.3-.5-.3h-.4c-.2 0-.4.1-.5.3s-.6.7-.6 1.4.3 1.6.3 1.7c.1.1 1.2 1.8 2.9 2.5.4.2.7.3 1 .4.5.1.8.1 1.1-.1.3-.2.6-.5.7-.9.1-.3.1-.6 0-.7-.1-.1-.2-.2-.4-.3zM12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8z" />
    </svg>
);

export const FileDownIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
...
export const VideoIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m22 8-6 4 6 4V8Z"></path><rect x="2" y="6" width="14" height="12" rx="2" ry="2"></rect></svg>
);
...
export const PaletteIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.47-1.125-.29-.289-.69-.47-1.128-.47H11c-.663 0-1.18-.537-1.18-1.2 0-.663.517-1.2 1.18-1.2h1.25c.663 0 1.18-.537 1.18-1.2 0-.663-.517-1.2-1.18-1.2h-1c-1.105 0-2.008-.895-2.008-2s.903-2 2.008-2h.548C19.344 3.125 22 6.13 22 10.5 22 16.77 17.5 22 12 22z" />
    </svg>
);

export const FontSizeIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M4 7V4h16v3" />
        <path d="M9 20h6" />
        <path d="M12 4v16" />
